...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      transition={{ duration: 0.6, delay:0.3, type:'spring', stiffness:100 }} className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Hatem Moalla <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
<motion.h1 initial={{ y:-20, opacity:0 }} whileInView={{ y:0, opacity:1 }}
      transition={{ duration: 0.6, delay:0.3, type:'spring', stiffness:100 }} className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>self taught web developer based in Tunisia</motion.h1>
