...
const Services = () => {
  return (
    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} transition={{ duration:1 }} id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      <motion.h4 initial={{ y:-20, opacity:0 }} whileInView={{ y:0 opacity:1 }} transition={{ duration:0.6, delay:0.8 }} className='text-center mb-2 text-lg font-Ovo'>What I offer</motion.h4>
