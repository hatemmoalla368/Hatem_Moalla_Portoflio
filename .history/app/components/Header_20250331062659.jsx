...
<motion.h1 initial={{ y:-30, opacity:0 }} whileInView={{ y:0, opacity:1 }}
      transition={{ duration: 0.8, delay:0.5, type:'spring', stiffness:100 }} className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>self taught web developer based in Tunisia</motion.h1>
