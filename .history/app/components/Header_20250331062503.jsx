...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      transition={{ duration: 0.6, type:'spring', stiffness:100 }} className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Hatem Moalla <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
