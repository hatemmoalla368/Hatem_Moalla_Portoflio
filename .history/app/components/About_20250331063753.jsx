...
const About = () => {
  return (
    <motion.div initial={{ opacity:0 }} whileInView={{ opacity:1 }} transition={{ duration:1 }} id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      <motion.h4 initial={{ opacity:0; y:-20 }} whileInView={{ opacity:1, y:0 }} transition={{ duration:0.5, delay }} className='text-center mb-2 text-lg font-Ovo'>Introduction</motion.h4>
