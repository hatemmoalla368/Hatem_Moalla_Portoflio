...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      transition={{ duration: 0.8, type:'spring', stiffness: }}>
        <Image src={assets.profile_img} alt='' className='rounded-full w-32' />
      </motion.div>
      <h3 className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Hatem Moalla <Image src={assets.hand_icon} alt='' className='w-6'/></h3>
